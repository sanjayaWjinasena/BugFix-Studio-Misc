...
""",
    ...
    'depends': [
        ...
        'BugFix-Project',    # ACL rows use x_departments, x_project_category etc.
                'BugFix-Accounting',  # ACL rows use account.move, x_studio_* fields
        'BugFix-Stock',  # ACL rows use stock.picking, x_material_request_* models
        'BugFix-MRP',  # ACL rows use mrp.production, x_mrp_* models
    ...
    'data': [
        ...
        'data/server_actions_f5_mailpost.xml',
        'data/window_actions_f4_extra.xml',
        'data/server_actions_f5_extra.xml',
        'data/groups_g.xml',
        'data/rules_f7.xml',
        ...
        'data/menus_f6r3_remaining.xml',
        'data/menus_f6r2_test_app_05.xml',
        'data/menus_f6_url.xml',
        'data/menus_f6_final.xml',
        'data/menus_f6.xml',
        'data/menus_website_faq.xml',
        'data/menus_from_routing.xml',
        'data/menus_d5.xml',
        'data/menus_root_deactivate.xml',
        'data/menus_cross_repo_routing.xml',
        'data/menus_visual_fixes.xml',
        'data/approval_rules_from_purchase.xml',
        'data/qweb_studio_reports.xml',
