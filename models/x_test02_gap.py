...
class XTest02Gap(models.Model):
    ...
    x_studio_charges_1 = fields.Many2many(comodel_name='x_trf_charges', string='Charges-1')
    x_studio_charges_2 = fields.Many2many(comodel_name='x_trf_charges', string='Charges-2')
    x_studio_many2many_field_JKvVx = fields.Many2many(comodel_name='x_misc_charge_codes', string='Misc Charge Codes')
    x_studio_many2many_field_c0IAp = fields.Many2many(comodel_name='x_trf_charges', string='Charges')
